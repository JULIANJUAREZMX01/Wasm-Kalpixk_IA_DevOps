...
def ensure_ensemble():
    ...
    if _ensemble is None:
        ...
        # Calibrate baseline if models are already trained (from disk or memory)
        ...
        with torch.no_grad():
            ...
            calibrated_thresh = min(0.8, max_score + 0.15)
            _ensemble.drift_guard._current_threshold = calibrated_thresh
