...
class DetectionEnsemble:
    ...
    def predict(self, features: torch.Tensor) -> tuple[list[float], list[str], list[float], float]:
        ...
        # Inferencia
        # We don't use the adaptive_threshold from iso_forest anymore,
        # we centralize it in drift_guard for the ensemble score.
        ...
        # Update and get unified adaptive threshold from Drift Guard
