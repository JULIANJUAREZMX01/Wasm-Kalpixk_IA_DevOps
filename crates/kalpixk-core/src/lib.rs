...
// To resolve linker issues in environments without a Zig compiler (like CI),
// we use internal Rust implementations from the motor module for all targets.
// Zig functions in motor.zig are maintained for specialized metal-layer builds.
