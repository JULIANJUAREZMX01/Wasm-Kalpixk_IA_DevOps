...
pub fn detect_embedded_node_defender(event: &KalpixkEvent) -> NodeResult {
    ...
    if raw.contains("embedded")
        ...
        || raw.contains("gpio_tamper")
        || raw.contains("bus_sniff")
    {
        score += 0.95;
    ...
    NodeResult {
        ...
        level: SeverityScore::new(score).as_level(),
        mitre_techniques: techniques,
        description: "Detection of probing, physical tampering, and side-channel sniffing against embedded defense nodes".to_string(),
    }
}
