...
export const v7_audit_tensor_wasm: (a: number, b: number) => number;
export const v8_ghost_heartbeat: (a: number, b: number, c: number, d: number) => [number, number];
export const v8_guerrilla_jit_shield_wasm: (a: number, b: number, c: any, d: bigint) => void;
export const v8_guerrilla_process: (a: number, b: number) => [number, number];
export const v8_pointer_poisoning_wasm: (a: number, b: number, c: any, d: bigint) => void;
export const v8_quantum_entropy_shredder_wasm: (a: number, b: number, c: any, d: number) => void;
