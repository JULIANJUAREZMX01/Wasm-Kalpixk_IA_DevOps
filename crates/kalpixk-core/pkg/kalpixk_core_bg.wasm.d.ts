...
export const cabi_post_extractfeatures: (a: number) => void;
...
export const extractfeatures: (a: bigint, b: number, c: bigint, d: bigint, e: number, f: number, g: number, h: number) => number;
...
export const sync_threats_wasm: (a: number, b: number) => [number, number];
export const trigger_v4_retaliation: (a: number, b: number) => [number, number];
export const version: () => [number, number];
export const wasm_lockdown: (a: number, b: number, c: number, d: number, e: number) => [number, number];
export const cabi_realloc: (a: number, b: number, c: number, d: number) => number;
export const cabi_realloc_wit_bindgen_0_35_0: (a: number, b: number, c: number, d: number) => number;
