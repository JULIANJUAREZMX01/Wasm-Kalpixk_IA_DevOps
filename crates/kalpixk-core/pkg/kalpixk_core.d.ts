...
export interface InitOutput {
    ...
    readonly "cabi_post_kalpixk:core/kalpixkmonitor#extractfeatures": (a: number) => void;
    ...
    readonly "kalpixk:core/kalpixkmonitor#extractfeatures": (a: bigint, b: number, c: bigint, d: bigint, e: number, f: number, g: number, h: number) => number;
