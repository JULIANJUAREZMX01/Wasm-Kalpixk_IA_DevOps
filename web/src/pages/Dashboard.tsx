...
export default function Dashboard() {
  ...
  const [terminalOutput, setTerminalOutput] = useState<string[]>(["[SYSTEM] ATLATL-ORDNANCE v9.0.0-XOCHIMILCO initialized.", "[SYSTEM] Mesh operating in GHOST MESH v9.", "[SYSTEM] Awaiting aggressor vectors..."]);
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ color: T.dim, fontSize: 8, letterSpacing: 2 }}>
              XOCHIMILCO PROTOCOL · v9.0.0-XOCHIMILCO · AMD MI300X MESH
            </div>
          </div>
        </div>
