        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ color: T.dim, fontSize: 8, letterSpacing: 2 }}>
              XOCHIMILCO METAL · v9.0.0-XOCHIMILCO · AMD MI300X MESH
            </div>
          </div>
        </div>
            ...
            <button
              onClick={async () => {
                try {
                  ...
                  alert("v9 XOCHIMILCO STRIKE ENGAGED: TOTAL SYSTEMIC COLLAPSE INITIATED");
                } catch (e) {
...
const RealtimeTab = React.memo(function RealtimeTab({ chart, terminalOutput }: { chart: { t: number; s: number }[], terminalOutput: string[] }) {
  ...
  const NODES = [
    ...
    { id: "XOCHI-9",  desc: "Mesh Auth",          load: 5,  port: 8087, status: "ACTIVE" },
    { id: "XOCHI-10", desc: "Integrity Guard",    load: 14, port: 8088, status: "ACTIVE" },
  ];
                ...
                strikes.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ display: "flex", gap: 20 }}>
                      ...
                      <div style={{ color: T.dim, fontSize: 9 }}>IMPACT: TOTAL_SYSTEMIC_COLLAPSE (50GB/s)</div>
