...
export default function Dashboard() {
  ...
  const [terminalOutput, setTerminalOutput] = useState<string[]>(["[SYSTEM] ATLATL-ORDNANCE v8.0.0-GUERRILLA initialized.", "[SYSTEM] Mesh operating in GHOST MESH v8.", "[SYSTEM] Awaiting aggressor vectors..."]);
                ...
                strikes.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ display: "flex", gap: 20 }}>
                      ...
                      <div style={{ color: T.dim, fontSize: 9 }}>IMPACT: SYSTEMIC_DESTRUCTION (25GB/s)</div>
