...
export default function Dashboard() {
  ...
  const [terminalOutput, setTerminalOutput] = useState<string[]>(["[SYSTEM] ATLATL-ORDNANCE v8.0.0-GUERRILLA initialized.", "[SYSTEM] Mesh operating in GHOST MODE v8.", "[SYSTEM] v8 Consensus synchronized across Alpha Stack.", "[SYSTEM] Awaiting aggressor vectors..."]);
              ...
              onClick={async () => {
                try {
                  ...
                  setTerminalOutput(prev => [
                    ...
                    `[STRIKE] NEURAL POISONING: ${data.neural_poisoning}`,
  ...
  return (
    <div style={{ flex: 1, display: "grid", gridTemplateColumns: "200px 1fr 240px", overflow: "hidden", gap: 1, background: T.border }}>
      ...
      <div style={{ background: T.panel, overflow: "auto", padding: 10 }}>
        ...
        <Label text="AMD MI300X — ROCm 8.0" accent={T.purple} />
                ...
                strikes.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ display: "flex", gap: 20 }}>
                      ...
                      <div style={{ color: T.dim, fontSize: 9 }}>IMPACT: DESTRUCTIVE_GUERRILLA (25GB/s)</div>
  ...
  return (
    <div style={{ flex: 1, padding: 20, overflow: "auto", background: T.panel }}>
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
        ...
        <p style={{ color: T.dim, fontSize: 10, marginBottom: 20, letterSpacing: 1 }}>
          AMD EPYC CPU vs AMD INSTINCT MI300X (ROCm 8.0) · Synthetic dataset · AMD Hackathon 2026
        </p>
